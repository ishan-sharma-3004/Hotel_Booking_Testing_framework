...
class TestCreateBooking:
    ...
    def test_create_valid_booking(self):
        ...
        with allure.step("Create booking with valid data"):
            response = requests.post(
                self.base_url, headers=self.headers, json=booking_data
            )
    ...
    def test_create_booking_with_invalid_data(self, invalid_data):
        ...
        with allure.step(
            f"Attempt to create booking with invalid data: {invalid_data}"
        ):
            response = requests.post(
                self.base_url, headers=self.headers, json=invalid_data
            )
